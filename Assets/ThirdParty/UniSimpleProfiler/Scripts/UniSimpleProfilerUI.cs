...
namespace UniSimpleProfiler
{
    ...
    public sealed partial class UniSimpleProfilerUI : MonoBehaviour
    {
        ...
        // 変数(readonly)
        //====================================================================================
        private readonly UniSimpleProfiler.Internal.FPSCounter m_fPSCounter = new Internal.FPSCounter();
        ...
        string FpsColor(int fps)
        {
            var color = "green";
            if (fps <= 25) color = "yellow";
            else if (fps < 20) color = "red";
            
            return $"<color=\"{color}\">{fps}</color>";
        }
    }
}