...
namespace StarterAssets
{
    ...
    public class MovementController : MonoBehaviour
    {
        ...
        [Tooltip("Toggle between First and Third Person")]
        ...
        {
            // For First Person: Rotate the player to match the camera rotation
            if (IsFirstPerson)
            {
                var cameraRotation = _mainCamera.rotation.eulerAngles;
                cameraRotation.x = 0;
                cameraRotation.z = 0;
